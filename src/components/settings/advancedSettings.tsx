...
const AdvancedSettings = () => {
  ...
  const hiddenCameraPreview = settingsStore((s) => s.hiddenCameraPreview)
              ...
              <div className="pl-16">
                <div className="my-24">
                  <div className="my-16 typography-16 font-bold">
                    {t('hiddenCameraPreview')}
                  </div>
                  <div className="my-8">
                    <TextButton
                      onClick={() =>
                        settingsStore.setState((s) => ({
                          hiddenCameraPreview: !s.hiddenCameraPreview,
                        }))
                      }
                    >
                      {hiddenCameraPreview ? t('StatusOn') : t('StatusOff')}
                    </TextButton>
                  </div>
                </div>
                <div className="my-24">
